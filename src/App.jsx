...
import AIIntelligenceHub from './components/intelligence/AIIntelligenceHub';
import AutoIngestHub from './components/ingestion/AutoIngestHub';
import ReportSettingsPage from './components/reports/ReportSettingsPage';
    ...
    { path: '/memory',      label: 'Finance Memory',   icon: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08 1.99 0 5.97 1.09 6 3.08-1.29 1.94-3.5 3.22-6 3.22z' },
      ...
      { path: '/cfo',         label: 'Digital CFO',      icon: 'M20 7H4a2 2 0 00-2 2v6a2 2 0 002 2h16a2 2 0 002-2V9a2 2 0 00-2-2z' },
          { path: '/drive-monitor', label: 'Drive Monitor', icon: 'M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z' },
                { path: '/report-settings', label: 'Intelligence Center', icon: 'M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9' },
          { path: '/ai-hub', label: 'AI Intelligence Hub', icon: 'M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.476A3.75 3.75 0 0118 20.25H6a3.75 3.75 0 01-2.988-1.474l-.548-.476z' },
          { path: '/auto-ingest', label: 'Auto-Ingest Hub', icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
        ...
        <div style={{flex:1,overflow:'hidden',position:'relative'}}>
          <div style={{
            ...
            {[...stocks,...stocks].map((st,i) => {
              ...
              return (
                <div key={i} style={{display:'inline-flex',alignItems:'center',gap:5,padding:'0 6px',borderRight:'1px solid #1e293b',height:26,flexShrink:0,whiteSpace:'nowrap'}}>
...
export default function App() {
  ...
  const routes = [
    ...
    { path: '/governance-docs-batch4', title: 'Investment, ESG & Legal Docs', sub: 'Investment Securities, ESG Sustainability, Legal Contracts — 18 documents.', comp: <Batch4DocsPage /> },
