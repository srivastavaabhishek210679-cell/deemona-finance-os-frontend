...
fs.writeFileSync('C:/deemona-finance-os/frontend/src/components/whatsapp/WhatsAppPage.jsx', content, 'utf8');
console.log('Written. Size:', content.length);
console.log('Has handleSend:', content.includes('handleSend'));
console.log('Has postAPI:', content.includes('postAPI'));
console.log('Has customMessage:', content.includes('customMessage'));
